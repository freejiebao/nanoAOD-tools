...
def set_samples(_year):
    ...
    if _year=='2016':
        ...
        sample['DY1']=['DYJetsToLL_Pt-50To100.root','DYJetsToLL_Pt-100To250.root','DYJetsToLL_Pt-250To400.root','DYJetsToLL_Pt-400To650.root','DYJetsToLL_Pt-650ToInf.root']
        sample['DY2']=['DYJetsToTauTau_ForcedMuEleDecay_M-50.root','DYJetsToTauTau_ForcedMuEleDecay_M-50_ext1.root']
        sample['DY3']=['DY1JetsToLL_M-10to50.root','DY2JetsToLL_M-10to50.root','DY3JetsToLL_M-10to50.root','DY4JetsToLL_M-10to50.root','DY1JetsToLL_M-50.root','DY2JetsToLL_M-50.root','DY3JetsToLL_M-50.root','DY4JetsToLL_M-50.root']
        sample['DY4']=['DYJetsToLL_M-50.root','DYJetsToLL_M-10to50.root']
