...
class btagSFProducer(Module):
    ...
    """
    def __init__(self, era, algo = 'deepcsv', sfFileName = None, verbose = 0):
        ...
        self.inputFilePath = os.environ['CMSSW_BASE'] + "/python/PhysicsTools/NanoAODTools/postprocessing/data/btagSF/"
...
btagSF2016 = lambda : btagSFProducer("Legacy2016")
