...
p=PostProcessor(".",inputFiles(),None,"%s/src/PhysicsTools/NanoAODTools/scripts/ssww_keep_and_drop_2016.txt",modules=[countHistogramsModule(),puWeight_2016(),PrefCorr(),sswwModule2016(),lepSF_2016()],provenance=True,justcount=False,noOut=False,fwkJobReport=True,outputbranchsel = "%s/src/PhysicsTools/NanoAODTools/scripts/ssww_output_branch_selection_2016.txt") %(os.environ['CMSSW_BASE'],os.environ['CMSSW_BASE'])
p.run()
