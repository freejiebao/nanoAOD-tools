...
def new_py(year):
    ...
    for iSample in _Samples:
        ...
        file_content += "config.JobType.inputFiles = [\'%s\',\'%s/src/PhysicsTools/NanoAODTools/scripts/\',\'%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/leptonSF/%s/muon/\',\'%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/leptonSF/%s/electron/\',\'%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/\'] #hadd nano will not be needed once nano tools are in cmssw\n" % (
        script, os.environ['CMSSW_BASE'], os.environ['CMSSW_BASE'],year,os.environ['CMSSW_BASE'],year,os.environ['CMSSW_BASE'])
